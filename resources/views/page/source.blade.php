...
<header id="header">
	...
	<div class="image phone"><div class="inner"><img src="{{ asset('page/images/screen.jpg') }}" alt="" /></div></div>
</header>
...
<section id="two" class="wrapper">
	<div class="inner alt">
		<section class="spotlight">
			<div class="image"><img src="{{ asset('page/images/pic01.jpg') }}" alt="" /></div>
			<div class="content">
		...
		<section class="spotlight">
			<div class="image"><img src="{{ asset('page/images/pic02.jpg') }}" alt="" /></div>
			<div class="content">
		...
		<section class="spotlight">
			<div class="image"><img src="{{ asset('page/images/pic03.jpg') }}" alt="" /></div>
			<div class="content">
